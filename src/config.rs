...
impl PeerConfig {
    ...
    // We can load them in two rouds, the first round loads the first 300 peers, and the second round loads the rest.
    // Then the UI will show the first 300 peers first, and the rest will be loaded and shown later.
    pub const BATCH_LOADING_COUNT: usize = 300;
